...
let sum2 = a + b + c
let times = a * b * c
return [sum2, times, `${a} and ${b} and ${c} sum to ${sum2}.`, `The product of ${a} and ${b} and ${c} is ${times}.`]
...
function sumArray(sumArr) { //eslint-disable-line
  let nsum = sum(sum(sumArr[0] , sumArr[1]),sumArr[2]);
return [nsum, `${sumArr[0]},${sumArr[1]},${sumArr[2]} was passed in as an array of numbers, and ${nsum} is their sum.`]
}
...
// Write your code here
function multiplyArray(multArr) { //eslint-disable-
  let prod = multiply((multiply(multArr[0] , multArr[1]))[0],multArr[2])[0];
  return [prod, `The numbers ${multArr[0]},${multArr[1]},${multArr[2]} have a product of ${prod}.`]
}
